...
3. **Executing Plans** (`/hyperpowers:execute-plan`) - Lead reads upfront task list, dispatches fresh executor subagent (Sonnet) per task, runs two-stage review (spec + code quality) after each task
