...
8. **Discover and create dynamic views for primary request paths:**
   ...
   For each discovered flow, create a dynamic view in `docs/arch/views/data-flows/`:
   ```
   views {
